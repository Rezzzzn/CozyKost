...
include 'php/koneksi.php'; // Sesuaikan path dengan lokasi file koneksi.php
...
$sql = "SELECT b.id_booking, k.nama_kost, k.harga, k.fasilitas, k.gambar1, k.gambar2
        FROM booking b
        JOIN kamar k ON b.id_kost = k.id_kost
        WHERE b.email = ?";
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        // Tampilkan data pesanan dan kamar
        echo "<div class='pesanan-item'>";
        echo "<h3>Pesanan ID: " . $row['id_booking'] . "</h3>";
        echo "<p>Nama Kost: " . $row['nama_kost'] . "</p>";
        echo "<p>Harga: Rp " . number_format($row['harga'], 0, ',', '.') . "</p>";
        echo "<p>Fasilitas: " . $row['fasilitas'] . "</p>";
        echo "<img src='" . $row['gambar1'] . "' alt='Gambar Kamar 1' style='width: 100px; height: 100px;'>";
        echo "<img src='" . $row['gambar2'] . "' alt='Gambar Kamar 2' style='width: 100px; height: 100px;'>";
        echo "</div>";
    }
} else {
    echo "<p>Anda belum memesan kamar apapun.</p>";
}
