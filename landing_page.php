...
<body>
        ...
        <div class="modal-dialog modal-dialog-scrollable">
            ...
            <div class="modal-body">
                ...
                <!-- Profile edit form -->
                <form id="editProfileForm" action="php/update_profile.php" method="POST">
                <div class="form-group mb-3">
                    <input type="email" class="form-control" id="email" name="email" placeholder=" &#xf0e0;   Email" required style="margin-bottom: -10px;font-family: 'Arial', FontAwesome;">
                </div>
                <div class="form-group mb-3">
                    <input type="text" class="form-control" id="username" name="username" placeholder=" &#xf007;   Username" required style="margin-bottom: -10px;font-family: 'Arial', FontAwesome;">
                </div>
                <div class="form-group mb-3">
                    <input type="password" class="form-control" id="password" name="password" placeholder=" &#xf023;   New Password" style="margin-bottom: -10px;font-family: 'Arial', FontAwesome;">
                </div>
                <div class="form-group mb-3">
                    <input type="password" class="form-control" id="confirmPassword" name="confirm_password" placeholder=" &#xf023;    Confirm Password" required style="margin-bottom: -10px;font-family: 'Arial', FontAwesome;">
                </div>
                </form>
            </div>
            <div class="modal-footer">
...
<div class="container-xxl py-5" id="paket">
    <div class="container">
        ...
        <div class="row g-4 justify-content-center">
            ...
            <!-- Paket 2 dengan status Kamar Tidak Tersedia -->
            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="package-item d-flex flex-column">
                    ...
                    <div class="text-center p-4 flex-grow-1">
                        ...
                        <div class="d-flex justify-content-center mb-2">
                        <a href="detail user.html" class="btn btn-md btn-secondary px-3 border-end disabled" style="border-radius: 30px 0 0 30px;">Pelajari Selengkapnya</a>
                        <a href="booking.html" class="btn btn-md btn-secondary px-3 disabled " style="border-radius: 0 30px 30px 0;" data-bs-toggle="modal" data-bs-target="#bookingModal">Booking Sekarang</a>
                        </div>
                    </div>
                </div>
            </div>

            <!-- Paket 3 dengan diskon -->
            ...
            <div class="row gy-5 gx-4 justify-content-center">
                <div class="col-lg-4 col-sm-6 text-center pt-4 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="position-relative border border-success pt-5 pb-4 px-4">
                        ...
                        <p class="mb-0">Pilihlah kamar kesukaanmu secara online. </p>
                    </div>
                </div>
